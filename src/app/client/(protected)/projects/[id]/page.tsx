...
async function getProjectDetail(projectId: string, clientId: string) {
...
export default async function ClientProjectDetailPage({ 
  ...
  const data = await getProjectDetail(projectId, viewerClient.id)
  ...
  return (
    <div className="space-y-6">
      <Link href="/client/projects" className="inline-flex">
        ...
        {project.link && (
          <div className="p-5 bg-white/5 border border-white/10">
            ...
            <a
              ...
              className="text-accent hover:text-accent/80 text-lg flex items-center gap-2"
            >
